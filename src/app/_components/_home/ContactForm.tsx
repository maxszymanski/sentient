            ...
            >
                <div className="flex w-full flex-col gap-5">
                    ...
                    <Input
                        ...
                        disabled={isSubmitting}
                        valueFromWatch={watch('message')}
                        placeholder="Select your operating system"
                    />
                </div>
                <button
                    type="submit"
                    className="text-dark my-outline hover: hover:text-dark/90 mt-8 flex h-[43px] w-full cursor-pointer items-center justify-center self-center rounded-[59px] border-[0.5px] border-white/50 bg-white transition-colors duration-300 hover:bg-white/90"
                    disabled={isSubmitting}
                >
